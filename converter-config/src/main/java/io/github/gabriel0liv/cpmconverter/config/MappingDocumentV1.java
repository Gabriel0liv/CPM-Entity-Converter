...
public record MappingDocumentV1(
    ...
    public MappingDocumentV1(Integer schemaVersion, Map<String, String> bones,
            Map<String, String> clips, Look look, Sampling sampling, List<String> ignore) {
        this(schemaVersion, null, null, null, null, Map.of(), bones, clips, look,
                Map.of(), sampling, ignore, null);
    }
    ...
    public record Look(String composition, Double neckInfluence, Double headInfluence,
            Boolean allowOverrotation, Map<String, Double> limits) {
        public Look(String composition, Double neckInfluence, Double headInfluence,
