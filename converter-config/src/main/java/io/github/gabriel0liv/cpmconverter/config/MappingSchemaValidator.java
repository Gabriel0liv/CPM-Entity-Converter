...
final class MappingSchemaValidator {
    private static final Set<String> PROPERTIES = Set.of("schemaVersion", "modelScale", "verticalOffset",
            "skin", "rootStrategy", "rootRoles", "bones", "clips", "look", "stateMappings",
            "sampling", "ignore", "diagnosticPolicy");
    ...
    DiagnosticBag validate(JsonNode root) {
        ...
        } else if (!root.get("schemaVersion").canConvertToInt() || root.get("schemaVersion").asInt() != 1) {
    ...
    static final class UnknownPropertyException extends RuntimeException {
        ...
        UnknownPropertyException(String property) { super("unknown mapping property: " + property); }
    }
}
