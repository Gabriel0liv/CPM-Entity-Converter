...
The generator creates 34 original fixtures. The real GeckoLib 4.4.9 core jar
and Forge JSON adapters were executed at commit
`25a41d7375bb7eeda37dadc04b1e03fe486b33e5`.

## Oracle execution

`artifacts/results.json` contains 34 parser results: 33 `PASS` and the expected
`PREPOST-005` `JsonParseException`. The run used GeckoLib's actual
