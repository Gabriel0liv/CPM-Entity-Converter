...
Status em 2026-08-27. T100–T303 têm implementação e gates automatizados executados;
T304 tem gate automatizado ProjectIO/round-trip/determinismo concluído e permanece
`[~]` exclusivamente pelo checklist visual CPM 0.6.27 pendente. `specified` continua
significando apenas contrato para tarefas futuras. IDs `TST-*` são testes planejados
em `test-plan.md`.
...
| FR-020 | ADR-003 | T302, T304 | S003/TST-ZIP/T304 ProjectIO gate | AC-001, AC-005 | implemented/tested automated |
| FR-021 | ADR-003 | T301, T304 | S003/TST-IDS/T304 ProjectIO gate | AC-002 | implemented/tested automated |
| FR-022 | ADR-003 | T303, T304 | S003/TST-VALIDATE/T304 ProjectIO gate | AC-001–004 | implemented/tested automated; visual pending |
...
| NFR-003 | determinism contract | T302, T304, T700 | S003/TST-DETERMINISM/T304 cross-platform golden | AC-005, AC-038 | T304 implemented/tested; T700 specified |
| NFR-004 | ADR-001/003 | T100, T302 | dependency audit | AC-001 | specified |
| NFR-005 | test plan | T204, T304, T700 | full suite + T304 official ProjectIO gate | AC-010–028 | T304 automated PASS; visual pending |
...
| NFR-014 | cross-platform | T304, T700 | Windows/Linux CI + frozen current hashes | AC-033 | T304 implemented/tested; T700 specified |
...
O gate automatizado T304 está registrado em `phase-3-t304-gate.md` e ficou terminalmente verde no CI run `33061294958`: `check` e `projectio-conformance` passaram em Ubuntu e Windows, incluindo geração dupla determinística, `GENERATED_V1`, load pelo `ProjectIO` oficial, materialização estática, save/reopen e golden SHA-256 cross-platform. Os quatro hashes exatos ficam em `verification-projectio/expected-artifact-hashes.properties`.

A evidência visual não foi executada. O vínculo manual por hash e o procedimento de CPM Editor 0.6.27 ficam em `phase-3-t304-manual-checklist.md`; portanto T304 permanece `[~]`.
