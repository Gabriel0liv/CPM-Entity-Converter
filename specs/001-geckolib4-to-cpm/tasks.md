...
- [x] T303 validator CPM em camadas — parser tipado, roots/targets, UV/textura, PNG RGBA8, canonicality diagnostics, summary, fixtures A/C, mutation evidence e Windows CI concluídos.
